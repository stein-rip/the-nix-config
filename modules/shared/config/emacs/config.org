...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "stein-rip"
    user-mail-address "stein@stein.rip")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/stein/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/stein/bin" "/profile/bin" "/Users/stein/.npm-packages/bin" "/Users/stein/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
