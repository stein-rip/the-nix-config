# Generated by Powerlevel10k configuration wizard on 2024-12-19 at 15:09 EST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# vertical separators, round heads, round tails, 2 lines, solid, right frame,
# dark-ornaments, sparse, many icons, fluent, transient_prompt, instant_prompt=verbose.
